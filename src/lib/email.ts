...
import { EMAIL_VERIFICATION_CODE_TTL_MINUTES } from './auth-constants';
  ...
  await transport.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px">
        ...
        <p style="color:#666">This code expires in <strong>${EMAIL_VERIFICATION_CODE_TTL_MINUTES} minutes</strong>.</p>
