      ...
      <div className="px-4 pt-6 max-w-[1200px] mx-auto space-y-6">
        ...
        <div className={`gap-3 ${isMobile ? 'flex flex-col' : 'grid grid-cols-2'}`}>
          {benefits.map((b, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 text-[18px]" style={{ backgroundColor: b.bg }}>
                {b.icon}
              </div>
              <div>
                <p className="text-[14px] font-bold text-foreground">{b.title}</p>
