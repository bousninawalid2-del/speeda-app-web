...
const recommendations = [
  { border: 'hsl(var(--orange))', title: 'Improve Response Time (+5 pts)', desc: 'You have 4 unanswered reviews. Responding within 1 hour improves your score and customer trust.', cta: 'Reply to Reviews →', nav: 'chat-engagement-reviews' },
  { border: 'hsl(var(--brand-blue))', title: 'Post More on TikTok (+3 pts)', desc: 'You posted 2 times on TikTok this week vs 6 on Instagram. Balancing platforms improves your coverage score.', cta: 'Create TikTok Post →', nav: 'create' },
  { border: 'hsl(var(--green))', title: 'Boost Your Top Post (+4 pts)', desc: 'Your Smash Burger Reel has 3x average engagement. Boosting it could push your campaign performance score higher.', cta: 'Boost Post →', nav: 'create' },
  { border: 'hsl(var(--brand-teal))', title: 'Complete This Week Quest (+2 pts)', desc: 'You need 2 more actions to complete your weekly quests. Share a customer review and connect your TikTok account.', cta: 'View Quests →', nav: '_quests' },
];
...
export const MosScoreScreen = ({ onBack, onNavigate }: MosScoreScreenProps) => {
      ...
      <div className={`px-4 pt-6 max-w-[1200px] mx-auto ${!isMobile ? 'grid grid-cols-2 gap-6' : 'space-y-5'}`}>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-card rounded-2xl border border-border-light p-6 flex flex-col items-center">
            ...
            <div className="mt-3 flex flex-col items-center gap-1">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[12px] text-muted-foreground font-medium">3/5 weekly quests</span>
                <div className="w-16 h-1.5 rounded-full bg-border overflow-hidden">
                  <motion.div className="h-full rounded-full" style={{ background: 'linear-gradient(90deg, hsl(var(--brand-blue)), hsl(var(--brand-teal)))' }} initial={{ width: 0 }} animate={{ width: '60%' }} transition={{ duration: 0.8, delay: 0.5 }} />
                </div>
              </div>
            </div>
          </div>
            ...
            {calcOpen && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} className="px-4 pb-4 space-y-4">
                ...
                <div className="pt-2 border-t border-border-light flex justify-between">
                  ...
                  <span className="text-[15px] font-bold" style={{ color: tierColor }}>74/100</span>
                </div>
              </motion.div>
            )}
          </div>
          ...
          <div className="bg-card rounded-2xl border border-border-light p-4">
            ...
            <div className="h-[160px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={historyData}>
                  ...
                  <YAxis domain={[50, 80]} tick={{ fontSize: 11, fill: 'hsl(220,9%,46%)' }} axisLine={false} tickLine={false} />
            ...
            <p className="text-[13px] font-bold mt-2" style={{ color: tierColor }}>Your score improved +16 points in 4 weeks 📈</p>
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <h3 className="text-[18px] font-bold text-foreground">✦ AI Recommendations to Improve Your Score</h3>
          ...
          <div ref={questsRef}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-primary/10 text-primary">3/5 completed</span>
            </div>
            <div className="bg-card rounded-2xl border border-border-light p-4 space-y-3">
              ...
              <div className="pt-3 border-t border-border-light">
                <div className="flex justify-between text-[12px] text-muted-foreground mb-1.5">
                  <span>3/5 quests</span>
                  <span>16/20 quest points earned</span>
                </div>
                <div className="w-full h-2 rounded-full bg-border overflow-hidden">
                  <motion.div className="h-full rounded-full" style={{ background: 'linear-gradient(90deg, hsl(var(--brand-blue)), hsl(var(--brand-teal)))' }} initial={{ width: 0 }} animate={{ width: '60%' }} transition={{ duration: 0.8 }} />
                </div>
              </div>
            </div>
          </div>
            ...
            {faqOpen && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} className="px-4 pb-4">
                <p className="text-[13px] text-muted-foreground leading-relaxed">
                  The Marketing Operating Score measures the overall health of your marketing efforts. A higher score means more consistent posting, better engagement, faster customer responses, and more effective campaigns. Elite status (81-100) unlocks priority AI features and detailed competitor insights.
                </p>
              </motion.div>
            )}
          </div>
