...
| `DISCUSSION_CODE_SECRET` | — | Secret used to generate stateless HMAC discussion codes (`disc_...`) for n8n payloads. If missing, discussion code is empty and engagement UI falls back to local mock data. |
